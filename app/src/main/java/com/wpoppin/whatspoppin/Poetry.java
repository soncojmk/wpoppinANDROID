...
public class Poetry extends Fragment {

    private static final String ENDPOINT = "http://www.wpoppin.com/api/poetry.json";
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        ((AppCompatActivity) getActivity()).getSupportActionBar().setTitle("Poetry Events");
